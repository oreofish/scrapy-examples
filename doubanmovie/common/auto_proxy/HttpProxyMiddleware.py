...
class HttpProxyMiddleware(object):
    ...
    def __init__(self, settings):
        ...
        self.recover_interval = settings.get('AUTO_NO_PROXY_TIMEOUT') or 120
        ...
        self.proxy_file = settings.get('AUTO_PROXY_FILE') or "proxyes.dat"
        # 是否在超时的情况下禁用代理
    ...
    def set_proxy(self, request):
        ...
        logger.info("==== use proxy %s" % proxy["proxy"])
        proxy["count"] += 1
